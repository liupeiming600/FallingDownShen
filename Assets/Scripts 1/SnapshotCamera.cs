...
public class SnapshotCamera : MonoBehaviour {
    ...
    /// <param name="name">The name that will be given to the new GameObject the SnapshotCamera will be attached to.</param>
    /// <returns>A new SnapshotCamera, ready for use.</returns>
    public static SnapshotCamera MakeSnapshotCamera (int layer = 6, string name = "Snapshot Camera")
    {
        if (layer < 0 || layer > 31)
    ...
    {
        directory = directory != "" ? Directory.CreateDirectory(directory).FullName : Directory.CreateDirectory(Path.Combine(Application.dataPath, "./Resources/images/players/")).FullName;
